...
void terrain_iter(int nrow, int ncol)
{
    ...
    for (int row = 0; row < nrow; row++)
    {
        ...
        for (int col = 0; col < ncol; col++)
        {
            ...
            // d = abs((row-LRPOINTrow)*(col - LRPOINTcol));
            // c = abs((LRPOINTrow-row)*(LRPOINTcol+10-col));
            // b = abs((LRPOINTrow+10-row)*(col - LRPOINTcol));
            // a = abs((LRPOINTrow+10-row)*(LRPOINTcol+10-col));
