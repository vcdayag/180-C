...
void terrain_iter(int n)
{
    ...
    for (int row = 0; row < n; row++)
    {
        ...
        for (int col = 0; col < n; col++)
        {
            ...
            MATRIX[row][col] = (a * A + b * B + c * C + d * D) / 100;
        }
    }
}
